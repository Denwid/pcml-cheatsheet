...
% ----------
\section{PCA and SVD}
Find the eigenvectors of the covariance matrix of the data. These form an orthonormal basis $\{ \bf{w}_1, ..., \bf{w}_N\}$ for the data in the directions that have highest variance.
...
\todo[inline]{TODO: Connection to SVD}
...
\todo[inline]{TODO: Credits sections!}
