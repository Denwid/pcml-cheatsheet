...
\section{General}
  ...
  In supervised learning, you are also given a  $\bf{y} = \begin{bmatrix} y_1 \quad y_2 \quad ... \quad y_{N} \end{bmatrix}^T$
  
  The goal is to predict a $\hat{y}$ given any $\bf{x}$.
...
\section{Least squares}
  ...
  $$ -2 \bf{y^T X} + 2 \bf{X^T X \beta} = 0$$
  We can solve this for $y$ directly (by Matrix manipulation)
...
\todo[inline]{Definitions of: Efficiency, Optimality, Consistency, Identifiability, Convexity}
